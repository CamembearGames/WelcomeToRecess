...
public class GeneralUIScript : MonoBehaviour
{
    ...
    public void UpdateActivity()
    {
        ...
        mySequence.Append(clockUI.DOLocalMove(new Vector3(0,0,0), 0.5f));
        ...
        mySequence.Append(clockUI.DOLocalMove(new Vector3(0,474,0), 0.5f));
        ...
        mySequence.InsertCallback(1.75f,PlaySound);
    ...
    public void UpdateBell()
    {
        ...
        if (true)
        {
            ...
            mySequence.Append(bellUI.DOPunchRotation(new Vector3(0f,0f,20f), 4f, 10));
            mySequence.Append(bellUI.DOLocalMove(bellUI_start_pos, 0.5f));
            
            mySequence.InsertCallback(0.05f,PlayBell);
            mySequence.Insert(0f, bellUI.DOScale(new Vector3(2f,2f,2f), 0.6f).SetEase(Ease.InOutCubic));
            mySequence.Insert(4.4f, bellUI.DOScale(bellUI_start_scale, 0.6f).SetEase(Ease.InOutCubic));
        }
    }
